...
export class AppComponent implements OnInit {
  ...
  shuffle(): Array<InventoryItem> {
    let shuffled: Array<InventoryItem> = []
    ...
    shuffled[0] = this.inventoryByCategory["top"][top]
    shuffled[1] = this.inventoryByCategory["bottom"][bottom]
    shuffled[2] = this.inventoryByCategory["outerwear"][outerwear]
    shuffled[3] = this.inventoryByCategory["shoes"][shoes]
    shuffled[4] = this.inventoryByCategory["accessory"][accessory]
